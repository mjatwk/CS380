...
## Copy assignment 6 files into assignment 5 directory

The basis of assignment 6 is assignment 5. You have to copy files in assignment 6 into assignment 5 directory. Also, you have to change the filename asstX.cpp to asst6.cpp.
